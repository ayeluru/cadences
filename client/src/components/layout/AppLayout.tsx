      ...
      <aside className="hidden md:flex w-64 flex-col border-r bg-card/50 backdrop-blur-xl sticky top-0 h-screen">
        ...
        <div className="p-4 border-t border-border/50">
          <div className="flex items-center gap-1 mb-2">
            <Link href="/account" className="flex items-center gap-3 px-4 py-3 flex-1 min-w-0 rounded-xl transition-colors hover:bg-muted group cursor-pointer">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-primary/70 flex items-center justify-center text-white text-xs font-bold shrink-0">
                {getInitials(user)}
              </div>
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="mt-auto border-t pt-4 space-y-2">
              <Link href="/account" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-muted">
