...
import { useFeedbackList, useToggleVote, useUpdateFeedback, type FeedbackWithCounts } from "@/hooks/use-feedback";
...
function SubmitFeedbackButton() {
  ...
  return (
    <>
      ...
      <SubmitFeedbackDialog open={open} onOpenChange={setOpen} />
    </>
  );
}
